...
import static org.happyuc.webuj.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
...
public class WalletUtils {
    ...
    /**
     * Generates a BIP-39 compatible HappyUC wallet. The private key for the wallet can
     ...
     * @return A BIP-39 compatible HappyUC wallet
    ...
    static String getDefaultKeyDirectory(String osName1) {
        ...
        if (osName.startsWith("mac")) {
            return String.format(
                    "%s%sLibrary%sHappyUC", System.getProperty("user.home"), File.separator,
                    File.separator);
        } else if (osName.startsWith("win")) {
            return String.format("%s%sHappyUC", System.getenv("APPDATA"), File.separator);
        } else {
            return String.format("%s%s.happyuc", System.getProperty("user.home"), File.separator);
        }
    }
