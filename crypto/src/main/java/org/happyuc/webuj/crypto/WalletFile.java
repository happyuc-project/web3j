...
public class WalletFile {
    ...
    public static class Crypto {
        ...
        // To support my Huc Wallet keys uncomment this annotation & comment out the above
    ...
    // If we need to work with MyHucWallet we'll need to use this deserializer, see the
    // following issue https://github.com/kvhnuke/hucwallet/issues/269
