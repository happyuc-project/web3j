...
/**
 * <p>HappyUC wallet file management. For reference, refer to
 * <a href="https://github.com/happyuc-project/wiki/wiki/Web3-Secret-Storage-Definition">
 * Web3 Secret Storage Definition</a> or the
 * <a href="https://github.com/happyuc-project/go-happyuc/blob/master/accounts/key_store_passphrase.go">
 * Go HappyUC client implementation</a>.</p>
 *
 * <p><strong>Note:</strong> the Bouncy Castle Scrypt implementation
 * {@link SCrypt}, fails to comply with the following
 * HappyUC reference
 * <a href="https://github.com/happyuc-project/wiki/wiki/Web3-Secret-Storage-Definition#scrypt">
