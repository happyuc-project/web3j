...
public class TransactionEncoderTest {
    ...
    public void testSignMessage() {
        byte[] signedMessage = TransactionEncoder.signMessage(
                createHucTransaction(), SampleKeys.CREDENTIALS);
    ...
    @Test
    public void testHucTransactionAsRlpValues() {
        List<RlpType> rlpStrings = TransactionEncoder.asRlpValues(createHucTransaction(),
    ...
    public void testEip155Transaction() {
        // https://github.com/happyuc-project/EIPs/issues/155
    ...
    private static RawTransaction createHucTransaction() {
