...
import static org.happyuc.webuj.abi.TypeDecoder.MAX_BYTE_LENGTH_FOR_HEX_STRING;
...
public class FunctionReturnDecoder {
     ...
     * @return {@link List} of values returned by function, {@link Collections#emptyList()} if invalid response
     */
    ...
    private static List<Type> build(String input, List<TypeReference<Type>> outputParameters) {
        ...
        for (TypeReference<?> typeReference : outputParameters) {
            try {
                @SuppressWarnings("unchecked") Class<Type> type = (Class<Type>) typeReference.getClassType();
