 ...
 * This is so that we can pass around Typed {@link org.happyuc.webuj.abi.datatypes.Array} types.
 *
...
public abstract class TypeReference<T extends org.happyuc.webuj.abi.datatypes.Type>
    ...
    public static <T extends org.happyuc.webuj.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
