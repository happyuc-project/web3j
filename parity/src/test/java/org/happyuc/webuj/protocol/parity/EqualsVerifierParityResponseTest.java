...
public class EqualsVerifierParityResponseTest {
    ...
    public void testTrace() {
        EqualsVerifier.forClass(org.happyuc.webuj.protocol.parity.methods.response.Trace.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
    ...
    public void testTraceSuicideAction() {
        EqualsVerifier.forClass(org.happyuc.webuj.protocol.parity.methods.response.Trace.SuicideAction.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
    ...
    public void testTraceCallAction() {
        EqualsVerifier.forClass(org.happyuc.webuj.protocol.parity.methods.response.Trace.CallAction.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
    ...
    public void testTraceCreateAction() {
        EqualsVerifier.forClass(org.happyuc.webuj.protocol.parity.methods.response.Trace.CreateAction.class)
                .suppress(Warning.NONFINAL_FIELDS)
                .suppress(Warning.STRICT_INHERITANCE)
                .verify();
    }
