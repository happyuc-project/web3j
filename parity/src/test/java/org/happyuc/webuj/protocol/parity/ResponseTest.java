...
public class ResponseTest extends ResponseTester {
    ...
    public void testParityFullTraceResponseStateDiff() {
        ...
        stateDiffMap.put("0x00a0a24b9f0e5ec7aa4c7389b8302fd0123194de", new StateDiff(new StateDiff.ChangedState("0x2067ee238a4648bed5797", "0x2067ee23f5d09db3d0397"), new StateDiff.UnchangedState(), new StateDiff.UnchangedState(), new HashMap<>()));
        stateDiffMap.put("0x14772e4f805b4dd2e69bd6d3f9b5edf0dfa5385a", new StateDiff(new StateDiff.ChangedState("0xf85a746b58c1fee", "0xf7eeea1663c73ee"), new StateDiff.UnchangedState(), new StateDiff.ChangedState("0x15", "0x16"), new HashMap<>()));
        //CHECKSTYLE:OFF
    ...
    public void testParityFullTraceResponseTraces() {
        //CHECKSTYLE:OFF
        // hacked toghuc from multiple requests and the code shortened
        ...
        trace1.setResult(new Trace.Result("0x1c9997559f6f1ae2ece8525eab68709f50865165", "0x606060405236156102b95763ffffffff60e060020a600035041663095ea7b381146102bb578063", "0x3ef6fe", null));
        ...
        List<org.happyuc.webuj.protocol.parity.methods.response.Trace> traces = new ArrayList<>();
        traces.add(trace1);
        traces.add(trace2);
        traces.add(trace3);
        traces.add(trace4);
    ...
    public void testParityFullTraceResponseVMTrace() {
        ...
        VMTrace.VMOperation operation1 = new VMTrace.VMOperation(null, BigInteger.valueOf(20000), new VMTrace.VMOperation.Ex(null, Collections.emptyList(), new VMTrace.VMOperation.Ex.Store("0x0", "0x14772e4f805b4dd2e69bd6d3f9b5edf0dfa5385a"), BigInteger.valueOf(241835)), BigInteger.valueOf(79));
