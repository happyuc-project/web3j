...
public class RequestTest extends RequestTester {
    ...
    public void testParityAllAccountsInfo() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_allAccountsInfo\"," + "\"params\":[],\"id\":1}");
    }
    ...
    public void testParityChangePassword() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_changePassword\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\",\"bazqux5\"],\"id\":1}");
        //CHECKSTYLE:ON
    }

    @Test
    public void testParityDeriveAddressHash() throws Exception {
        Derivation hashType = Derivation.createDerivationHash("0x2547ea3382099c7c76d33dd468063b32d41016aacb02cbd51ebc14ff5d2b6a43", "hard");

        webuj.parityDeriveAddressHash("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2", hashType, false).send();

        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_deriveAddressHash\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\"," + "{\"hash\":\"0x2547ea3382099c7c76d33dd468063b32d41016aacb02cbd51ebc14ff5d2b6a43\",\"type\":\"hard\"},false],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityDeriveAddressIndex() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_deriveAddressIndex\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\"," + "[{\"index\":1,\"type\":\"hard\"},{\"index\":2,\"type\":\"soft\"}],false],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityExportAccount() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_exportAccount\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityGetDappAddresses() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_getDappAddresses\"," + "\"params\":[\"web\"],\"id\":1}");
    }
    ...
    public void testParityGetDefaultDappAddress() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_getDappDefaultAddress\"," + "\"params\":[\"web\"],\"id\":1}");
    }

    public void testParityGetNewDappsAddresses() throws Exception {
        webuj.parityAllAccountsInfo().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_getNewDappsAddresses\"," + "\"params\":[],\"id\":1}");
    }

    public void testParityGetNewDappsDefaultAddress() throws Exception {
        webuj.parityGetNewDappsDefaultAddress().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_getNewDappsDefaultAddress\"," + "\"params\":[],\"id\":1}");
    }
    ...
    public void testParityImportGhucAccounts() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_importGhucAccounts\"," + "\"params\":[[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]],\"id\":1}");
    }
    ...
    public void testParityKillAccount() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_killAccount\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityListAccountsNoAccountOffsetNoBlockTag() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listAccounts\"," + "\"params\":[100,null],\"id\":1}");
    }
    ...
    public void testParityListAccountsNoAccountOffsetWithBlockTag() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listAccounts\"," + "\"params\":[100,null,\"0x1\"],\"id\":1}");
    }
    ...
    public void testParityListAccountsWithAccountOffsetWithBlockTag() throws Exception {
        ...
        webuj.parityListAccounts(maxQuantityReturned, "0x407d73d8a49eeb85d32cf465507dd71d507100c1", blockParameter).send();
    ...
    public void testParityListAccountsWithAccountOffsetNoBlockTag() throws Exception {
        BigInteger maxQuantityReturned = BigInteger.valueOf(100);
        webuj.parityListAccounts(maxQuantityReturned, "0x407d73d8a49eeb85d32cf465507dd71d507100c1", null).send();

        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listAccounts\"," + "\"params\":[100,\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityListGhucAccounts() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listGhucAccounts\"," + "\"params\":[],\"id\":1}");
    }

    public void testParityListRecentDapps() throws Exception {
        webuj.parityListRecentDapps().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listRecentDapps\"," + "\"params\":[],\"id\":1}");
    }
    ...
    public void testParityNewAccountFromPhrase() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_newAccountFromPhrase\"," + "\"params\":[\"phrase\",\"password\"],\"id\":1}");
    }
    ...
    public void testParityNewAccountFromSecret() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_newAccountFromSecret\"," + "\"params\":[\"0x1db2c0cf57505d0f4a3d589414f0a0025ca97421d2cd596a9486bc7e2cd2bf8b\",\"password\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testParityRemoveAddress() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_removeAddress\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"],\"id\":1}");
    }
    ...
    public void testParitySetAccountMeta() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setAccountMeta\"," + "\"params\":[\"0xfc390d8a8ddb591b010fda52f4db4945742c3809\",{\"foo\":\"bar\"}]," + "\"id\":1}");
    }

    @Test
    public void testParitySetAccountName() throws Exception {
        webuj.paritySetAccountName("0xfc390d8a8ddb591b010fda52f4db4945742c3809", "Savings").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setAccountName\"," + "\"params\":[\"0xfc390d8a8ddb591b010fda52f4db4945742c3809\",\"Savings\"]," + "\"id\":1}");
    }
    ...
    public void testParitySetDappAddresses() throws Exception {
        ...
        webuj.paritySetDappAddresses("web", dAppAddresses).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setDappAddresses\"," + "\"params\":[\"web\",[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]]," + "\"id\":1}");
    }

    @Test
    public void testParitySetDappDefaultAddress() throws Exception {
        webuj.paritySetDappDefaultAddress("web", "0x407d73d8a49eeb85d32cf465507dd71d507100c1").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setDappDefaultAddress\"," + "\"params\":[\"web\",\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]," + "\"id\":1}");
    }
    ...
    public void testParitySetNewDappsAddresses() throws Exception {
        ArrayList<String> dAppAddresses = new ArrayList<>();
        dAppAddresses.add("0x407d73d8a49eeb85d32cf465507dd71d507100c1");
        webuj.paritySetNewDappsAddresses(dAppAddresses).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setNewDappsAddresses\"," + "\"params\":[[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]]," + "\"id\":1}");
    }

    @Test
    public void testParitySetNewDappsDefaultAddress() throws Exception {
        webuj.paritySetNewDappsDefaultAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_setNewDappsDefaultAddress\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]," + "\"id\":1}");
    }

    @Test
    public void testParityTestPassword() throws Exception {
        webuj.parityTestPassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_testPassword\"," + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"hunter2\"]," + "\"id\":1}");
    }
    ...
    public void testParitySignMessage() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_signMessage\"," + "\"params\":[\"0xc171033d5cbff7175f29dfd3a63dda3d6f8f385e\",\"password1\"," + "\"0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testTraceRawTransaction() throws Exception {
        //CHECKSTYLE:OFF
        webuj.traceRawTransaction("0xf869808504e3b292008305499d94781ab1a38837e351bfe1e318c6587766848abffa8084b46300ec26a0b1ffd8f843e08a9dbf0a42b3c7dd5288a48885cd6e3bcdb2609e943d0b0053d4a07bfdb3c12a7cec896bfc2cfc7c346a2cb411e1aca62ad085e8d7abbb6532e128", Arrays.asList("trace", "vmTrace", "stateDiff")).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"trace_rawTransaction\"," + "\"params\":[" + "\"0xf869808504e3b292008305499d94781ab1a38837e351bfe1e318c6587766848abffa8084b46300ec26a0b1ffd8f843e08a9dbf0a42b3c7" + "dd5288a48885cd6e3bcdb2609e943d0b0053d4a07bfdb3c12a7cec896bfc2cfc7c346a2cb411e1aca62ad085e8d7abbb6532e128\"," + "[\"trace\",\"vmTrace\",\"stateDiff\"]]," + "\"id\":1}");
        //CHECKSTYLE:ON
    }

    @Test
    public void testTraceReplayTransaction() throws Exception {
        webuj.traceReplayTransaction("0x090a4bbdeb57f15fe252cccc924255855eda45a2d8f65b12ec81f03e2cc33249", Arrays.asList("trace", "vmTrace", "stateDiff")).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"trace_replayTransaction\"," + "\"params\":[" + "\"0x090a4bbdeb57f15fe252cccc924255855eda45a2d8f65b12ec81f03e2cc33249\"," + "[\"trace\",\"vmTrace\",\"stateDiff\"]]," + "\"id\":1}");
    }
    ...
    public void testTraceBlock() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"trace_block\"," + "\"params\":[\"latest\"]," + "\"id\":1}");
    }

    @Test
    public void testTraceFilter() throws Exception {
        webuj.traceFilter(new TraceFilter(DefaultBlockParameterName.EARLIEST, DefaultBlockParameterName.LATEST, Collections.singletonList("0xa9bebd4853ce06c3dc1b711bbafa1514ed5b5130"), Collections.singletonList("0xB4d9b203d8D16f41916a62DEab83389cF2b7eeCb"))).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"trace_filter\"," + "\"params\":[{\"fromBlock\":\"earliest\",\"toBlock\":\"latest\"," + "\"fromAddress\":[\"0xa9bebd4853ce06c3dc1b711bbafa1514ed5b5130\"]," + "\"toAddress\":[\"0xB4d9b203d8D16f41916a62DEab83389cF2b7eeCb\"]}]," + "\"id\":1}");
    }

    @Test
    public void testTraceGet() throws Exception {
        webuj.traceGet("0x090a4bbdeb57f15fe252cccc924255855eda45a2d8f65b12ec81f03e2cc33249", Arrays.asList(BigInteger.valueOf(2), BigInteger.ZERO, BigInteger.ZERO)).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"trace_get\"," + "\"params\":[" + "\"0x090a4bbdeb57f15fe252cccc924255855eda45a2d8f65b12ec81f03e2cc33249\"," + "[\"0x2\",\"0x0\",\"0x0\"]]," + "\"id\":1}");
    }
}