...
public class ConvertTest {
    ...
    public void testFromWei() {
        ...
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.TWEI),
                is(new BigDecimal("21")));
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.PWEI),
                is(new BigDecimal("0.021")));
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.HUC),
                is(new BigDecimal("0.000021")));
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.KHUC),
                is(new BigDecimal("0.000000021")));
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.MHUC),
                is(new BigDecimal("0.000000000021")));
        assertThat(Convert.fromWei("21000000000000", Convert.Unit.GHUC),
    ...
    public void testToWei() {
        ...
        assertThat(Convert.toWei("21", Convert.Unit.PWEI),
                is(new BigDecimal("21000000000000000")));
        assertThat(Convert.toWei("21", Convert.Unit.HUC),
                is(new BigDecimal("21000000000000000000")));
        assertThat(Convert.toWei("21", Convert.Unit.KHUC),
                is(new BigDecimal("21000000000000000000000")));
        assertThat(Convert.toWei("21", Convert.Unit.MHUC),
                is(new BigDecimal("21000000000000000000000000")));
        assertThat(Convert.toWei("21", Convert.Unit.GHUC),
