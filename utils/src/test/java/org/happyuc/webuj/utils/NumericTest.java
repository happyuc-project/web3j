...
import static org.happyuc.webuj.utils.Numeric.asByte;


public class NumericTest {

    private static final byte[] HEX_RANGE_ARRAY = new byte[]{Numeric.asByte(0x0, 0x1), Numeric.asByte(0x2, 0x3), Numeric.asByte(0x4, 0x5), Numeric.asByte(0x6, 0x7), Numeric.asByte(0x8, 0x9), Numeric.asByte(0xa, 0xb), Numeric.asByte(0xc, 0xd), Numeric.asByte(0xe, 0xf)};
    ...
    public void testQuantityEncodeLeadingZero() {
        ...
        assertThat(Numeric.toHexStringWithPrefixSafe(BigInteger.valueOf(Long.MAX_VALUE)), equalTo("0x7fffffffffffffff"));
        assertThat(Numeric.toHexStringWithPrefixSafe(new BigInteger("204516877000845695339750056077105398031")), equalTo("0x99dc848b94efc27edfad28def049810f"));
    }
    ...
    public void testQuantityDecode() {
        ...
        assertThat(Numeric.decodeQuantity("0x99dc848b94efc27edfad28def049810f"), equalTo(new BigInteger("204516877000845695339750056077105398031")));
    }
    ...
    public void testToBytesPadded() {
        ...
        assertThat(Numeric.toBytesPadded(BigInteger.TEN, 8), is(new byte[]{0, 0, 0, 0, 0, 0, 0, 0xa}));

        assertThat(Numeric.toBytesPadded(BigInteger.valueOf(Integer.MAX_VALUE), 4), is(new byte[]{0x7f, (byte) 0xff, (byte) 0xff, (byte) 0xff}));
    }
    ...
    public void testToHexStringNoPrefixZeroPadded() {
        ...
        assertThat(Numeric.toHexStringNoPrefixZeroPadded(new BigInteger("11c52b08330e05d731e38c856c1043288f7d9744", 16), 40), is("11c52b08330e05d731e38c856c1043288f7d9744"));

        assertThat(Numeric.toHexStringNoPrefixZeroPadded(new BigInteger("01c52b08330e05d731e38c856c1043288f7d9744", 16), 40), is("01c52b08330e05d731e38c856c1043288f7d9744"));
    }
    ...
    public void testToHexStringWithPrefixZeroPadded() {
        ...
        assertThat(Numeric.toHexStringWithPrefixZeroPadded(new BigInteger("01c52b08330e05d731e38c856c1043288f7d9744", 16), 40), is("0x01c52b08330e05d731e38c856c1043288f7d9744"));
    ...
    public void testIsIntegerValue() {
        ...
        assertTrue(Numeric.isIntegerValue(new BigDecimal("9999999999999999999999999999999999999999999999999999999999999999.0")));
        assertTrue(Numeric.isIntegerValue(new BigDecimal("-9999999999999999999999999999999999999999999999999999999999999999.0")));
