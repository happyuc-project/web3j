...
public interface webujRx {
     ...
     */
    Observable<HucBlock> replayBlocksObservable(
     ...
     */
    Observable<HucBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<HucBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
