 ...
 * details on additional Parity fields present in HucBlock.</p>
 */
public class HucBlock extends Response<HucBlock.Block> {

    @Override
    @JsonDeserialize(using = HucBlock.ResponseDeserialiser.class)
