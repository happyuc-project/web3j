...
public class Transaction {
    // default as per https://github.com/happyuc-project/wiki/wiki/JSON-RPC#eth_sendtransaction
    ...
    public static Transaction createHucCallTransaction(String from, String to, String data) {
