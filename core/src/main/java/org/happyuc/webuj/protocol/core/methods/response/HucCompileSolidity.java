...
public class HucCompileSolidity extends Response<Map<String, HucCompileSolidity.Code>> {
    ...
    public static class SolidityInfo {
        ...
        public SolidityInfo(String source, String language, String languageVersion, String compilerVersion, String compilerOptions, List<AbiDefinition> abiDefinition, Documentation userDoc, Documentation developerDoc) {
            this.source = source;
    ...
    public static class Documentation {
        ...
        // See https://github.com/ethereum/wiki/wiki/JSON-RPC#huc_compilesolidity
