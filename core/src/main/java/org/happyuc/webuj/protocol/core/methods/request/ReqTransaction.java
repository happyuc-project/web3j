...
public class ReqTransaction {
    // default as per https://github.com/ethereum/wiki/wiki/JSON-RPC#huc_sendtransaction
    ...
    public static ReqTransaction createHucerTransaction(String from, BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String to, BigInteger value) {
