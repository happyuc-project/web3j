...
public interface HappyUC {
    ...
    Request<?, HucGetBalance> hucGetBalance(
            String address, DefaultBlockParameter defaultBlockParameter);

    Request<?, HucGetStorageAt> hucGetStorageAt(
            String address, BigInteger position,
            DefaultBlockParameter defaultBlockParameter);

    Request<?, HucGetTransactionCount> hucGetTransactionCount(
            String address, DefaultBlockParameter defaultBlockParameter);

    Request<?, HucGetBlockTransactionCountByHash> hucGetBlockTransactionCountByHash(
            String blockHash);

    Request<?, HucGetBlockTransactionCountByNumber> hucGetBlockTransactionCountByNumber(
            DefaultBlockParameter defaultBlockParameter);

    Request<?, HucGetUncleCountByBlockHash> hucGetUncleCountByBlockHash(String blockHash);

    Request<?, HucGetUncleCountByBlockNumber> hucGetUncleCountByBlockNumber(
            DefaultBlockParameter defaultBlockParameter);
    ...
    Request<?, org.happyuc.webuj.protocol.core.methods.response.HucSendTransaction> hucSendTransaction(
            org.happyuc.webuj.protocol.core.methods.request.Transaction transaction);

    Request<?, org.happyuc.webuj.protocol.core.methods.response.HucSendTransaction> hucSendRawTransaction(
            String signedTransactionData);

    Request<?, org.happyuc.webuj.protocol.core.methods.response.HucCall> hucCall(
            org.happyuc.webuj.protocol.core.methods.request.Transaction transaction,
            DefaultBlockParameter defaultBlockParameter);

    Request<?, HucEstimateGas> hucEstimateGas(
            org.happyuc.webuj.protocol.core.methods.request.Transaction transaction);

    Request<?, HucBlock> hucGetBlockByHash(String blockHash, boolean returnFullTransactionObjects);

    Request<?, HucBlock> hucGetBlockByNumber(
            DefaultBlockParameter defaultBlockParameter,
            boolean returnFullTransactionObjects);

    Request<?, HucTransaction> hucGetTransactionByHash(String transactionHash);

    Request<?, HucTransaction> hucGetTransactionByBlockHashAndIndex(
            String blockHash, BigInteger transactionIndex);

    Request<?, HucTransaction> hucGetTransactionByBlockNumberAndIndex(
            DefaultBlockParameter defaultBlockParameter, BigInteger transactionIndex);

    Request<?, HucGetTransactionReceipt> hucGetTransactionReceipt(String transactionHash);

    Request<?, HucBlock> hucGetUncleByBlockHashAndIndex(
            String blockHash, BigInteger transactionIndex);

    Request<?, HucBlock> hucGetUncleByBlockNumberAndIndex(
            DefaultBlockParameter defaultBlockParameter, BigInteger transactionIndex);
    ...
    Request<?, org.happyuc.webuj.protocol.core.methods.response.ShhPost> shhPost(
            org.happyuc.webuj.protocol.core.methods.request.ShhPost shhPost);
