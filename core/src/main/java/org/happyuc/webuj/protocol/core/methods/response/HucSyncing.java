 ...
 */
public class HucSyncing extends Response<HucSyncing.Result> {

    @Override
    @JsonDeserialize(using = HucSyncing.ResponseDeserialiser.class)
    public void setResult(HucSyncing.Result result) {
    ...
    // these fields although not present in the RPC specification are returned by Ghuc 1.4.10
