...
public interface WebujRx {
     ...
     *
     * @return Observable that emits all new block hashes as new blocks are created on the blockchain
     */
    Observable<String> hucBlockHashObservable();
     ...
     */
    Observable<String> hucPendingTransactionHashObservable();
     ...
     */
    Observable<HucBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<HucBlock> replayBlocksObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock, boolean fullTransactionObjects);
     ...
     * @return Observable to emit these blocks
     */
    Observable<HucBlock> replayBlocksObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock, boolean fullTransactionObjects, boolean ascending);
     ...
     */
    Observable<HucBlock> catchUpToLatestBlockObservable(DefaultBlockParameter startBlock, boolean fullTransactionObjects, Observable<HucBlock> onCompleteObservable);
     ...
     * @return Observable to emit all requested blocks
     */
    Observable<HucBlock> catchUpToLatestBlockObservable(DefaultBlockParameter startBlock, boolean fullTransactionObjects);
     ...
     */
    Observable<HucBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(DefaultBlockParameter startBlock, boolean fullTransactionObjects);
