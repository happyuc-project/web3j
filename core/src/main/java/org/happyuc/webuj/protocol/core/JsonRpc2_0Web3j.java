...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    public Request<?, EthSendTransaction>
        ...
        return new Request<org.happyuc.webuj.protocol.core.methods.request.Transaction, EthSendTransaction>(
                "eth_sendTransaction",
    ...
    public Request<?, EthCall> ethCall(
            org.happyuc.webuj.protocol.core.methods.request.Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
    ...
    @Override
    public Request<?, EthEstimateGas> ethEstimateGas(org.happyuc.webuj.protocol.core.methods.request.Transaction transaction) {
        return new Request<org.happyuc.webuj.protocol.core.methods.request.Transaction, EthEstimateGas>(
                "eth_estimateGas",
                Arrays.asList(transaction),
                web3jService,
    ...
    public Request<?, EthFilter> ethNewFilter(
            org.happyuc.webuj.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<org.happyuc.webuj.protocol.core.methods.request.EthFilter, EthFilter>(
                "eth_newFilter",
    ...
    public Request<?, EthLog> ethGetLogs(
            org.happyuc.webuj.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<org.happyuc.webuj.protocol.core.methods.request.EthFilter, EthLog>(
                "eth_getLogs",
                Arrays.asList(ethFilter),
                web3jService,
                EthLog.class);
    ...
    @Override
    public Request<?, ShhPost> shhPost(org.happyuc.webuj.protocol.core.methods.request.ShhPost shhPost) {
        return new Request<org.happyuc.webuj.protocol.core.methods.request.ShhPost, ShhPost>(
                "shh_post",
