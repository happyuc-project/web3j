...
public final class ENS extends Contract {
    ...
    private ENS(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    private ENS(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<String> resolver(byte[] node) {
        Function function = new Function("resolver", Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<String> owner(byte[] node) {
        Function function = new Function("owner", Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteCall<BigInteger> ttl(byte[] node) {
        Function function = new Function("ttl", Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Uint64>() {}));
    ...
    public static RemoteCall<ENS> deploy(Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, webuj, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, webuj, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static ENS load(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, webuj, transactionManager, gasPrice, gasLimit);
    }
