 ...
 *
 * <p>Generated with webuj version 3.0.1.
 */
public final class PublicResolver extends Contract {
    ...
    private PublicResolver(String contractAddress, Webuj web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    private PublicResolver(String contractAddress, Webuj web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public List<AddrChangedEventResponse> getAddrChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("AddrChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}), Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
    ...
    public Observable<AddrChangedEventResponse> addrChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        return webuj.hucLogObservable(filter).map(new Func1<Log, AddrChangedEventResponse>() {
            @Override
    ...
    public List<ContentChangedEventResponse> getContentChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("ContentChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}), Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
        List<EventValues> valueList = extractEventParameters(event, repTransactionReceipt);
    ...
    public Observable<ContentChangedEventResponse> contentChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        HucReqFilter filter = new HucReqFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(event));
        return webuj.hucLogObservable(filter).map(new Func1<Log, ContentChangedEventResponse>() {
            @Override
    ...
    public List<NameChangedEventResponse> getNameChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("NameChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}), Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        List<EventValues> valueList = extractEventParameters(event, repTransactionReceipt);
    ...
    public Observable<NameChangedEventResponse> nameChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        HucReqFilter filter = new HucReqFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(event));
        return webuj.hucLogObservable(filter).map(new Func1<Log, NameChangedEventResponse>() {
            @Override
    ...
    public List<ABIChangedEventResponse> getABIChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("ABIChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}), Arrays.<TypeReference<?>>asList());
        List<EventValues> valueList = extractEventParameters(event, repTransactionReceipt);
    ...
    public Observable<ABIChangedEventResponse> aBIChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        HucReqFilter filter = new HucReqFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(event));
        return webuj.hucLogObservable(filter).map(new Func1<Log, ABIChangedEventResponse>() {
            @Override
    ...
    public List<PubkeyChangedEventResponse> getPubkeyChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("PubkeyChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}), Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}));
        List<EventValues> valueList = extractEventParameters(event, repTransactionReceipt);
    ...
    public Observable<PubkeyChangedEventResponse> pubkeyChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        HucReqFilter filter = new HucReqFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(event));
        return webuj.hucLogObservable(filter).map(new Func1<Log, PubkeyChangedEventResponse>() {
            @Override
    ...
    public List<TextChangedEventResponse> getTextChangedEvents(RepTransactionReceipt repTransactionReceipt) {
        final Event event = new Event("TextChanged", Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Utf8String>() {}), Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        List<EventValues> valueList = extractEventParameters(event, repTransactionReceipt);
    ...
    public Observable<TextChangedEventResponse> textChangedEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        HucReqFilter filter = new HucReqFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(event));
        return webuj.hucLogObservable(filter).map(new Func1<Log, TextChangedEventResponse>() {
            @Override
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        Function function = new Function("supportsInterface", Arrays.<Type>asList(new Bytes4(interfaceID)), Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    }

    public RemoteCall<RepTransactionReceipt> setText(byte[] node, String key, String value) {
        Function function = new Function("setText", Arrays.<Type>asList(new Bytes32(node), new Utf8String(key), new Utf8String(value)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function("ABI", Arrays.<Type>asList(new Bytes32(node), new Uint256(contentTypes)), Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}, new TypeReference<DynamicBytes>() {}));
        return new RemoteCall<Tuple2<BigInteger, byte[]>>(new Callable<Tuple2<BigInteger, byte[]>>() {
            @Override
            public Tuple2<BigInteger, byte[]> call() throws Exception {
                List<Type> results = executeCallMultipleValueReturn(function);
                ;
                return new Tuple2<BigInteger, byte[]>((BigInteger) results.get(0).getValue(), (byte[]) results.get(1).getValue());
            }
        });
    }

    public RemoteCall<RepTransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        Function function = new Function("setPubkey", Arrays.<Type>asList(new Bytes32(node), new Bytes32(x), new Bytes32(y)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<byte[]> content(byte[] node) {
        Function function = new Function("content", Arrays.<Type>asList(new Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
        return executeRemoteCallSingleValueReturn(function, byte[].class);
    }

    public RemoteCall<String> addr(byte[] node) {
        Function function = new Function("addr", Arrays.<Type>asList(new Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<String> text(byte[] node, String key) {
        Function function = new Function("text", Arrays.<Type>asList(new Bytes32(node), new Utf8String(key)), Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<RepTransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        Function function = new Function("setABI", Arrays.<Type>asList(new Bytes32(node), new Uint256(contentType), new DynamicBytes(data)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<String> name(byte[] node) {
        Function function = new Function("name", Arrays.<Type>asList(new Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<RepTransactionReceipt> setName(byte[] node, String name) {
        Function function = new Function("setName", Arrays.<Type>asList(new Bytes32(node), new Utf8String(name)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<RepTransactionReceipt> setContent(byte[] node, byte[] hash) {
        Function function = new Function("setContent", Arrays.<Type>asList(new Bytes32(node), new Bytes32(hash)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<Tuple2<byte[], byte[]>> pubkey(byte[] node) {
        final Function function = new Function("pubkey", Arrays.<Type>asList(new Bytes32(node)), Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}));
        return new RemoteCall<Tuple2<byte[], byte[]>>(new Callable<Tuple2<byte[], byte[]>>() {
            @Override
            public Tuple2<byte[], byte[]> call() throws Exception {
                List<Type> results = executeCallMultipleValueReturn(function);
                ;
                return new Tuple2<byte[], byte[]>((byte[]) results.get(0).getValue(), (byte[]) results.get(1).getValue());
            }
        });
    }

    public RemoteCall<RepTransactionReceipt> setAddr(byte[] node, String addr) {
        Function function = new Function("setAddr", Arrays.<Type>asList(new Bytes32(node), new Address(addr)), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public static RemoteCall<PublicResolver> deploy(Webuj web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
    ...
    public static RemoteCall<PublicResolver> deploy(Webuj web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static PublicResolver load(String contractAddress, Webuj web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static PublicResolver load(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, webuj, transactionManager, gasPrice, gasLimit);
    }
