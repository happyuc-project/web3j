...
public final class PublicResolver extends Contract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        Function function = new Function("supportsInterface", Arrays.asList(new Bytes4(interfaceID)), Arrays.asList(new TypeReference<Bool>() {}));
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function("ABI", Arrays.asList(new Bytes32(node), new Uint256(contentTypes)), Arrays.asList(new TypeReference<Uint256>() {}, new TypeReference<DynamicBytes>() {}));
    ...
    public RemoteCall<byte[]> content(byte[] node) {
        Function function = new Function("content", Arrays.asList(new Bytes32(node)), Arrays.asList(new TypeReference<Bytes32>() {}));
        return executeRemoteCallSingleValueReturn(function, byte[].class);
    }

    public RemoteCall<String> addr(byte[] node) {
        Function function = new Function("addr", Arrays.asList(new Bytes32(node)), Arrays.asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteCall<String> text(byte[] node, String key) {
        Function function = new Function("text", Arrays.asList(new Bytes32(node), new Utf8String(key)), Arrays.asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteCall<String> name(byte[] node) {
        Function function = new Function("name", Arrays.asList(new Bytes32(node)), Arrays.asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteCall<Tuple2<byte[], byte[]>> pubkey(byte[] node) {
        final Function function = new Function("pubkey", Arrays.asList(new Bytes32(node)), Arrays.asList(new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}));
        return new RemoteCall<>(() -> {
            List<Type> results = executeCallMultipleValueReturn(function);
            return new Tuple2<>((byte[]) results.get(0).getValue(), (byte[]) results.get(1).getValue());
        });
    }
    ...
    public static RemoteCall<PublicResolver> deploy(Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, webuj, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<PublicResolver> deploy(Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, webuj, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static PublicResolver load(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, webuj, credentials, gasPrice, gasLimit);
    }
