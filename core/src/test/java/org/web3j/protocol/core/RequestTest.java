...
public class RequestTest extends RequestTester {
    ...
    public void testWeb3Sha3() throws Exception {
        webuj.web3Sha3("0x68656c6c6f20776f726c64").send();
    ...
    public void testHucProtocolVersion() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"method\":\"huc_protocolVersion\",\"params\":[],\"id\":1}");
    }
    ...
    public void testHucGetBalance() throws Exception {
        webuj.hucGetBalance("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                DefaultBlockParameterName.LATEST).send();

        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"method\":\"huc_getBalance\","
    ...
    public void testHucGetStorageAt() throws Exception {
        webuj.hucGetStorageAt("0x295a70b2de5e3953354a6a8344e616ed314d7251", BigInteger.ZERO,
                DefaultBlockParameterName.LATEST).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getStorageAt\","
    ...
    public void testHucGetTransactionCount() throws Exception {
        webuj.hucGetTransactionCount("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
                DefaultBlockParameterName.LATEST).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getTransactionCount\","
                + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"latest\"],"
                + "\"id\":1}");
    }
    ...
    public void testHucGetBlockTransactionCountByNumber() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getBlockTransactionCountByNumber\","
                + "\"params\":[\"0xe8\"],\"id\":1}");
    }

    @Test
    public void testHucGetUncleCountByBlockHash() throws Exception {
        webuj.hucGetUncleCountByBlockHash(
                "0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238").send();
    ...
    public void testHucSendTransaction() throws Exception {
        webuj.hucSendTransaction(new Transaction(
    ...
    public void testHucCall() throws Exception {
        webuj.hucCall(Transaction.createHucCallTransaction(
                "0xa70e8dd61c5d32be8058bb8eb970870f07233155",
                "0xb60e8dd61c5d32be8058bb8eb970870f07233155",
                        "0x0"),
                DefaultBlockParameter.valueOf("latest")).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_call\","
    ...
    public void testHucGetBlockByNumber() throws Exception {
        webuj.hucGetBlockByNumber(
                DefaultBlockParameter.valueOf(Numeric.toBigInt("0x1b4")), true).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getBlockByNumber\","
                + "\"params\":[\"0x1b4\",true],\"id\":1}");
    }

    @Test
    public void testHucGetTransactionByHash() throws Exception {
        webuj.hucGetTransactionByHash(
                "0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getTransactionByHash\",\"params\":["
    ...
    public void testHucGetTransactionByBlockHashAndIndex() throws Exception {
        webuj.hucGetTransactionByBlockHashAndIndex(
                "0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331",
    ...
    public void testHucGetTransactionByBlockNumberAndIndex() throws Exception {
        webuj.hucGetTransactionByBlockNumberAndIndex(
                DefaultBlockParameter.valueOf(Numeric.toBigInt("0x29c")), BigInteger.ZERO).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getTransactionByBlockNumberAndIndex\","
                + "\"params\":[\"0x29c\",\"0x0\"],\"id\":1}");
    }

    @Test
    public void testHucGetTransactionReceipt() throws Exception {
        webuj.hucGetTransactionReceipt(
                "0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getTransactionReceipt\",\"params\":["
                + "\"0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238\"],"
                + "\"id\":1}");
    }
    ...
    public void testHucGetUncleByBlockHashAndIndex() throws Exception {
        webuj.hucGetUncleByBlockHashAndIndex(
                "0xc6ef2fc5426d6ad6fd9e2a26abeab0aa2411b7ab17f30a99d3cb96aed1d1055b",
                BigInteger.ZERO).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getUncleByBlockHashAndIndex\","
                + "\"params\":["
    ...
    public void testHucGetUncleByBlockNumberAndIndex() throws Exception {
        webuj.hucGetUncleByBlockNumberAndIndex(
                DefaultBlockParameter.valueOf(Numeric.toBigInt("0x29c")), BigInteger.ZERO).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getUncleByBlockNumberAndIndex\","
                + "\"params\":[\"0x29c\",\"0x0\"],\"id\":1}");
    }
    ...
    public void testHucGetCompilers() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getCompilers\","
                + "\"params\":[],\"id\":1}");
    }

    @Test
    public void testHucCompileSolidity() throws Exception {
        webuj.hucCompileSolidity(
                "contract test { function multiply(uint a) returns(uint d) {   return a * 7;   } }")
                .send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_compileSolidity\","
    ...
    public void testHucCompileLLL() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_compileLLL\","
    ...
    public void testHucCompileSerpent() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_compileSerpent\","
    ...
    public void testHucNewFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_newFilter\","
    ...
    public void testHucNewBlockFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_newBlockFilter\","
                + "\"params\":[],\"id\":1}");
    }
    ...
    public void testHucNewPendingTransactionFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_newPendingTransactionFilter\","
                + "\"params\":[],\"id\":1}");
    }
    ...
    public void testHucUninstallFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_uninstallFilter\","
                + "\"params\":[\"0x0b\"],\"id\":1}");
    }
    ...
    public void testHucGetFilterChanges() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getFilterChanges\","
                + "\"params\":[\"0x16\"],\"id\":1}");
    }
    ...
    public void testHucGetFilterLogs() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getFilterLogs\","
                + "\"params\":[\"0x16\"],\"id\":1}");
    }

    @Test
    public void testHucGetLogs() throws Exception {
        webuj.hucGetLogs(new HucFilter().addSingleTopic(
                "0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b"))
                .send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_getLogs\","
                + "\"params\":[{\"topics\":["
                + "\"0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b\"]}],"
                + "\"id\":1}");
    }
    ...
    public void testHucGetLogsWithNumericBlockRange() throws Exception {
        webuj.hucGetLogs(new HucFilter(
                DefaultBlockParameter.valueOf(Numeric.toBigInt("0xe8")),
                DefaultBlockParameter.valueOf("latest"), ""))
                .send();

        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"method\":\"huc_getLogs\","
    ...
    public void testHucSubmitWork() throws Exception {
        webuj.hucSubmitWork("0x0000000000000001",
                "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
                "0xD1FE5700000000000000000000000000D1FE5700000000000000000000000000").send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"huc_submitWork\","
