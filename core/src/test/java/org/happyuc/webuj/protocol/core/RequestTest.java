...
public class RequestTest extends RequestTester {
    ...
    protected void initWeb3Client(HttpService httpService) {
        webuj = WebujFactory.build(httpService);
    }
    ...
    public void testEthGetBlockTransactionCountByNumber() throws Exception {
        webuj.hucGetBlockTransactionCountByNumber(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0xe8"))).send();
    ...
    public void testEthGetUncleCountByBlockNumber() throws Exception {
        webuj.hucGetUncleCountByBlockNumber(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0xe8"))).send();
    ...
    public void testEthGetCode() throws Exception {
        webuj.hucGetCode("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b", DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0x2"))).send();
    ...
    public void testEthCall() throws Exception {
        webuj.hucCall(ReqTransaction.createHucCallTransaction("0xa70e8dd61c5d32be8058bb8eb970870f07233155", "0xb60e8dd61c5d32be8058bb8eb970870f07233155", "0x0"), DefaultBlockParameterName.fromString("latest")).send();
    ...
    public void testEthGetBlockByNumber() throws Exception {
        webuj.hucGetBlockByNumber(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0x1b4")), true).send();
    ...
    public void testEthGetTransactionByBlockNumberAndIndex() throws Exception {
        webuj.hucGetTransactionByBlockNumberAndIndex(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0x29c")), BigInteger.ZERO).send();
    ...
    public void testEthGetUncleByBlockNumberAndIndex() throws Exception {
        webuj.hucGetUncleByBlockNumberAndIndex(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0x29c")), BigInteger.ZERO).send();
    ...
    public void testEthGetLogsWithNumericBlockRange() throws Exception {
        webuj.hucGetLogs(new HucReqFilter(DefaultBlockParameterNumber.valueOf(Numeric.toBigInt("0xe8")), DefaultBlockParameterName.LATEST, "")).send();
