...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testBuildFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.happyuc.webuj.protocol.core.RemoteCall<org.happyuc.webuj.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param) {\n"
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.happyuc.webuj.protocol.core.RemoteCall<org.happyuc.webuj.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param, java.math.BigInteger weiValue) {\n"
                        + "  final org.happyuc.webuj.abi.datatypes.Function function = new org.happyuc.webuj.abi.datatypes.Function(\n"
                        + "      \"functionName\", \n"
                        + "      java.util.Arrays.<org.happyuc.webuj.abi.datatypes.Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<org.happyuc.webuj.abi.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildFunctionConstantSingleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.happyuc.webuj.protocol.core.RemoteCall<java.math.BigInteger> functionName(java.math.BigInteger param) {\n"
    ...
    public void testBuildFunctionConstantSingleValueRawListReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public org.happyuc.webuj.protocol.core.RemoteCall<java.util.List> functionName(java.math.BigInteger param) {\n"
                + "  final org.happyuc.webuj.abi.datatypes.Function function = new org.happyuc.webuj.abi.datatypes.Function(\"functionName\", \n"
                + "      java.util.Arrays.<org.happyuc.webuj.abi.datatypes.Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Uint8(param)), \n"
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        + "  public java.util.List<TransferEventResponse> getTransferEvents(org.happyuc.webuj.protocol.core.methods.response.TransactionReceipt transactionReceipt) {\n"
                        + "    java.util.List<org.happyuc.webuj.tx.Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TRANSFER_EVENT, transactionReceipt);\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(org.happyuc.webuj.protocol.core.methods.request.HucFilter filter) {\n"
                        ...
                        + "    org.happyuc.webuj.protocol.core.methods.request.HucFilter filter = new org.happyuc.webuj.protocol.core.methods.request.HucFilter(startBlock, endBlock, getContractAddress());\n"
