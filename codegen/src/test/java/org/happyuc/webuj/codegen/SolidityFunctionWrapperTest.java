...
import org.happyuc.webuj.abi.datatypes.generated.*;
...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testCreateValidParamName() {
        assertThat(SolidityFunctionWrapper.createValidParamName("param", 1), is("param"));
        assertThat(SolidityFunctionWrapper.createValidParamName("", 1), is("param1"));
    }

    @Test
    public void testBuildTypeName() {
        assertThat(SolidityFunctionWrapper.buildTypeName("uint256"), Is.<TypeName>is(ClassName.get(Uint256.class)));
        assertThat(SolidityFunctionWrapper.buildTypeName("uint64"), Is.<TypeName>is(ClassName.get(Uint64.class)));
        assertThat(SolidityFunctionWrapper.buildTypeName("string"), Is.<TypeName>is(ClassName.get(Utf8String.class)));

        assertThat(SolidityFunctionWrapper.buildTypeName("uint256[]"), Is.<TypeName>is(ParameterizedTypeName.get(DynamicArray.class, Uint256.class)));

        assertThat(SolidityFunctionWrapper.buildTypeName("uint256[] storage"), Is.<TypeName>is(ParameterizedTypeName.get(DynamicArray.class, Uint256.class)));

        assertThat(SolidityFunctionWrapper.buildTypeName("uint256[] memory"), Is.<TypeName>is(ParameterizedTypeName.get(DynamicArray.class, Uint256.class)));

        assertThat(SolidityFunctionWrapper.buildTypeName("uint256[10]"), Is.<TypeName>is(ParameterizedTypeName.get(StaticArray10.class, Uint256.class)));

        assertThat(SolidityFunctionWrapper.buildTypeName("uint256[33]"), Is.<TypeName>is(ParameterizedTypeName.get(StaticArray.class, Uint256.class)));
    }

    @Test
    public void testGetNativeType() {
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Address.class)), equalTo(TypeName.get(String.class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Uint256.class)), equalTo(TypeName.get(BigInteger.class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Int256.class)), equalTo(TypeName.get(BigInteger.class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Utf8String.class)), equalTo(TypeName.get(String.class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Bool.class)), equalTo(TypeName.get(Boolean.class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(Bytes32.class)), equalTo(TypeName.get(byte[].class)));
        assertThat(SolidityFunctionWrapper.getNativeType(TypeName.get(DynamicBytes.class)), equalTo(TypeName.get(byte[].class)));
    }

    @Test
    public void testGetNativeTypeParameterized() {
        assertThat(SolidityFunctionWrapper.getNativeType(ParameterizedTypeName.get(ClassName.get(DynamicArray.class), TypeName.get(Address.class))), IsEqual.<TypeName>equalTo(ParameterizedTypeName.get(ClassName.get(List.class), TypeName.get(String.class))));
    }
    ...
    public void testGetEventNativeType() {
        assertThat(SolidityFunctionWrapper.getEventNativeType(TypeName.get(Utf8String.class)), equalTo(TypeName.get(byte[].class)));
    }

    @Test
    public void testGetEventNativeTypeParameterized() {
        assertThat(SolidityFunctionWrapper.getEventNativeType(ParameterizedTypeName.get(ClassName.get(DynamicArray.class), TypeName.get(Address.class))), equalTo(TypeName.get(byte[].class)));
    }

    @Test
    public void testBuildFunctionTransaction() throws Exception {
        AbiDefinition functionDefinition = new AbiDefinition(false, Arrays.<AbiDefinition.NamedType>asList(new AbiDefinition.NamedType("param", "uint8")), "functionName", Collections.<AbiDefinition.NamedType>emptyList(), "type", false);
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        AbiDefinition functionDefinition = new AbiDefinition(false, Arrays.<AbiDefinition.NamedType>asList(new AbiDefinition.NamedType("param", "uint8")), "functionName", Collections.<AbiDefinition.NamedType>emptyList(), "type", true);
    ...
    public void testBuildFunctionConstantInvalid() throws Exception {
        AbiDefinition functionDefinition = new AbiDefinition(true, Arrays.<AbiDefinition.NamedType>asList(new AbiDefinition.NamedType("param", "uint8")), "functionName", Collections.<AbiDefinition.NamedType>emptyList(), "type", false);
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        AbiDefinition functionDefinition = new AbiDefinition(false, Arrays.asList(id, fromAddress, toAddress, value, message), "Transfer", new ArrayList<AbiDefinition.NamedType>(), "event", false);
