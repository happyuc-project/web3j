...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGenerationJvmTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.happyuc.webuj.unittests.java", JAVA_TYPES_ARG);
    ...
    private void testCodeGenerationSolidityTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.happyuc.webuj.unittests.solidity", SOLIDITY_TYPES_ARG);
    }
