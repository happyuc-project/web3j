...
public class HumanStandardToken extends Contract {
    ...
    public RemoteCall<TransactionReceipt> approve(String _spender, BigInteger _value) {
        final Function function = new Function(
                "approve", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_spender), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), 
    ...
    public RemoteCall<TransactionReceipt> transferFrom(String _from, String _to, BigInteger _value) {
        final Function function = new Function(
                "transferFrom", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_from), 
                new org.happyuc.webuj.abi.datatypes.Address(_to), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> balanceOf(String _owner) {
        final Function function = new Function("balanceOf", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_owner)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<TransactionReceipt> transfer(String _to, BigInteger _value) {
        final Function function = new Function(
                "transfer", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_to), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> approveAndCall(String _spender, BigInteger _value, byte[] _extraData) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_spender), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value), 
                new org.happyuc.webuj.abi.datatypes.DynamicBytes(_extraData)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> allowance(String _owner, String _spender) {
        final Function function = new Function("allowance", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(_owner), 
                new org.happyuc.webuj.abi.datatypes.Address(_spender)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.generated.Uint256(_initialAmount), 
                new org.happyuc.webuj.abi.datatypes.Utf8String(_tokenName), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint8(_decimalUnits), 
                new org.happyuc.webuj.abi.datatypes.Utf8String(_tokenSymbol)));
