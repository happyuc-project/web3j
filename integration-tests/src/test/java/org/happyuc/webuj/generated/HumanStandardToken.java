...
public class HumanStandardToken extends Contract {
    ...
    public static final Event TRANSFER_EVENT = new Event("Transfer", Arrays.asList(new TypeReference<Address>() {}, new TypeReference<Address>() {}), Arrays.asList(new TypeReference<Uint256>() {}));

    public static final Event APPROVAL_EVENT = new Event("Approval", Arrays.asList(new TypeReference<Address>() {}, new TypeReference<Address>() {}), Arrays.asList(new TypeReference<Uint256>() {}));
    ...
    public List<ApprovalEventResponse> getApprovalEvents(RepTransactionReceipt repTransactionReceipt) {
    ...
    public Observable<ApprovalEventResponse> approvalEventObservable(HucReqFilter filter) {
        return webuj.hucLogObservable(filter).map(log -> {
    ...
    public RemoteCall<RepTransactionReceipt> approve(String _spender, BigInteger _value) {
        final Function function = new Function("approve", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_spender), new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), Collections.emptyList());
    ...
    public RemoteCall<RepTransactionReceipt> transferFrom(String _from, String _to, BigInteger _value) {
        final Function function = new Function("transferFrom", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_from), new org.happyuc.webuj.abi.datatypes.Address(_to), new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> balanceOf(String _owner) {
        final Function function = new Function("balanceOf", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_owner)), Arrays.asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<RepTransactionReceipt> transfer(String _to, BigInteger _value) {
        final Function function = new Function("transfer", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_to), new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value)), Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<RepTransactionReceipt> approveAndCall(String _spender, BigInteger _value, byte[] _extraData) {
        final Function function = new Function("approveAndCall", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_spender), new org.happyuc.webuj.abi.datatypes.generated.Uint256(_value), new org.happyuc.webuj.abi.datatypes.DynamicBytes(_extraData)), Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<BigInteger> allowance(String _owner, String _spender) {
        final Function function = new Function("allowance", Arrays.asList(new org.happyuc.webuj.abi.datatypes.Address(_owner), new org.happyuc.webuj.abi.datatypes.Address(_spender)), Arrays.asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
