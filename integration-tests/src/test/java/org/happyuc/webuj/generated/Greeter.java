...
public class Greeter extends Contract {
    ...
    protected Greeter(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    protected Greeter(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<String> greet() {
        final Function function = new Function("greet", Arrays.asList(), Arrays.asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public static RemoteCall<Greeter> deploy(Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String _greeting) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.asList(new org.happyuc.webuj.abi.datatypes.Utf8String(_greeting)));
        return deployRemoteCall(Greeter.class, webuj, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<Greeter> deploy(Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String _greeting) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.asList(new org.happyuc.webuj.abi.datatypes.Utf8String(_greeting)));
        return deployRemoteCall(Greeter.class, webuj, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static Greeter load(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Greeter(contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    public static Greeter load(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Greeter(contractAddress, webuj, transactionManager, gasPrice, gasLimit);
    }
}
