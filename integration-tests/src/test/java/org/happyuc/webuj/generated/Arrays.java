...
public class Arrays extends Contract {
    ...
    public RemoteCall<TransactionReceipt> fixedReverse(List<BigInteger> input) {
        final Function function = new Function(
                "fixedReverse", 
                java.util.Arrays.<Type>asList(new StaticArray10<org.web3j.abi.datatypes.generated.Uint256>(
                        org.web3j.abi.Utils.typeMap(input, Uint256.class))),
    ...
    public RemoteCall<TransactionReceipt> dynamicReverse(List<BigInteger> input) {
        final Function function = new Function(
                "dynamicReverse", 
                java.util.Arrays.<Type>asList(new DynamicArray<org.web3j.abi.datatypes.generated.Uint256>(
                        org.web3j.abi.Utils.typeMap(input, Uint256.class))),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
