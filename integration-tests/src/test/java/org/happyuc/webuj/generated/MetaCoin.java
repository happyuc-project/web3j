...
public class MetaCoin extends Contract {
    ...
    public RemoteCall<BigInteger> getBalanceInHuc(String addr) {
        final Function function = new Function("getBalanceInHuc", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(addr)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
    ...
    public RemoteCall<TransactionReceipt> sendCoin(String receiver, BigInteger amount) {
        final Function function = new Function(
                "sendCoin", 
                Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(receiver), 
                new org.happyuc.webuj.abi.datatypes.generated.Uint256(amount)), 
