...
public class MetaCoin extends Contract {
    ...
    protected MetaCoin(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    protected MetaCoin(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<BigInteger> getBalanceInHuc(String addr) {
        final Function function = new Function("getBalanceInHuc", Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(addr)), Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
    ...
    public RemoteCall<BigInteger> getBalance(String addr) {
        final Function function = new Function("getBalance", Arrays.<Type>asList(new org.happyuc.webuj.abi.datatypes.Address(addr)), Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public static RemoteCall<MetaCoin> deploy(Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(MetaCoin.class, webuj, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<MetaCoin> deploy(Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(MetaCoin.class, webuj, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static MetaCoin load(String contractAddress, Webuj webuj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new MetaCoin(contractAddress, webuj, credentials, gasPrice, gasLimit);
    }

    public static MetaCoin load(String contractAddress, Webuj webuj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new MetaCoin(contractAddress, webuj, transactionManager, gasPrice, gasLimit);
    }
