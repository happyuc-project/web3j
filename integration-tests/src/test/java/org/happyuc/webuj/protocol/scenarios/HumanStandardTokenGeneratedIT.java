...
import static org.happyuc.webuj.generated.HumanStandardToken.ApprovalEventResponse;
import static org.happyuc.webuj.generated.HumanStandardToken.TransferEventResponse;
...
public class HumanStandardTokenGeneratedIT extends Scenario {
    ...
    public void testContract() throws Exception {
        ...
        Subscription transferEventSubscription = contract.transferEventObservable(DefaultBlockParameterName.EARLIEST, DefaultBlockParameterName.LATEST).subscribe(transferEventResponse -> transferEventCountDownLatch.countDown());

        CountDownLatch approvalEventCountDownLatch = new CountDownLatch(1);
        Subscription approvalEventSubscription = contract.approvalEventObservable(DefaultBlockParameterName.EARLIEST, DefaultBlockParameterName.LATEST).subscribe(transferEventResponse -> transferEventCountDownLatch.countDown());
        // CHECKSTYLE:ON
