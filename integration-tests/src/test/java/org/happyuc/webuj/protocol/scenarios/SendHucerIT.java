 ...
 */
public class SendHucerIT extends Scenario {
    ...
    public void testTransferEther() throws Exception {
        ...
        ReqTransaction reqTransaction = ReqTransaction.createHucerTransaction(ALICE.getAddress(), nonce, GAS_PRICE, GAS_LIMIT, BOB.getAddress(), value);
    ...
    public void testTransfer() throws Exception {
        RepTransactionReceipt repTransactionReceipt = Transfer.sendFunds(webuj, ALICE, BOB.getAddress(), BigDecimal.valueOf(0.2), Convert.Unit.ETHER).send();
