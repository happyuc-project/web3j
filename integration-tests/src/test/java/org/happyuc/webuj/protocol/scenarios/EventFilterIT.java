...
public class EventFilterIT extends Scenario {
    ...
    public void testEventFilter() throws Exception {
        ...
        Event event = new Event("Notify", Collections.<TypeReference<?>>emptyList(), Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
        ...
        assertThat(results, equalTo(Arrays.<Type>asList(new Uint256(BigInteger.valueOf(7)), new Uint256(BigInteger.valueOf(13)))));
